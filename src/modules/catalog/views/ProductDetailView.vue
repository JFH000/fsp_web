          ...
          <div class="bg-slate-50 rounded-2xl p-5 border border-slate-100">
            ...
            <div class="flex gap-3">
              <div class="flex items-center border border-slate-200 rounded-xl overflow-hidden bg-white">
                <button @click="qty > 1 && qty--" class="px-3 py-3 text-slate-500 hover:bg-slate-50 transition-colors text-lg font-bold">−</button>
                <span class="px-4 text-base font-semibold min-w-[3rem] text-center">{{ qty }}</span>
                <button @click="qty < product.stock && qty++" class="px-3 py-3 text-slate-500 hover:bg-slate-50 transition-colors text-lg font-bold">+</button>
              </div>
              <button
                @click="handleAdd"
