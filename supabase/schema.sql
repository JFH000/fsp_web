...
-- RLS: stock tables are admin-only
-- stock_receipts: admins can SELECT, INSERT, UPDATE
-- stock_movements: admins can SELECT and INSERT only (immutable ledger — no UPDATE/DELETE)
